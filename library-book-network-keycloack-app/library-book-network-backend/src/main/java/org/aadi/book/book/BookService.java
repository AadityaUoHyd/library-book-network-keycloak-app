...
import org.aadi.book.common.PageResponse;
import org.aadi.book.exception.OperationNotPermittedException;
import org.aadi.book.file.FileStorageService;
import org.aadi.book.history.BookTransactionHistory;
import org.aadi.book.history.BookTransactionHistoryRepository;
...
public class BookService {
    ...
    public Integer save(BookRequest request, Authentication connectedUser) {
        ...
        String ownerEmail = bookRepository.findOwnerEmailById(connectedUser.getName());
        book.setOwner(ownerEmail);
